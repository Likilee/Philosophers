...
/* 생성할 헤더파일의 이름을 적어주세요. */
#define HEADER_NAME "one.h"

/* 사용할 헤더파일들을 "" 사이에 적어주세요 공백(space)로 구분하여 적어주세요.
** 사용자 헤더파일을 적을 때 쌍따옴표앞에 역슬래시를 붙여주세요 ( " -> \") */
#define LIB "<stdio.h> <sys/time.h> <string.h> <stdlib.h> <unistd.h> <pthread.h> <semaphore.h>"

/* 사용할 매크로를 적어주세요 여러개가 있다면 ',' 로 구분해 주세요
** ex) #define MECRO "BUFFER_SIZE 32, MAX 1024"
** 쌍따옴표앞에 역슬래시를 붙여주세요 STR \"hello\" ( " -> \") */
#define MACRO "USE 1, NOT_USE 0, NO_LIMIT -1, TRUE 1, FALSE 0, DEAD 1, ALIVE 0, SLEEPING 0, EATING 1, FORKING 2, THINKING 3, DYING 4, NOTHING 5, FULL 6"
